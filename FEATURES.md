...
> **Status, 2026-09-09:** everything below is built. The v2.4, v2.5, v2.6 and v2.7 items — Trip Story sharing, occasion reminders, streaks, Admin Insights, the icon pass, Year in Review, header search, Want to Try, plans/roles, menu lookup and the patterns page — are **built and committed but not yet pushed to Netlify**, so they are not on the live site yet; `ROADMAP.md` marks them. Everything else here is live.
>
