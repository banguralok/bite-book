...
> **Status, 2026-09-09:** everything below is built. The v2.4 through v2.8 items — Trip Story sharing, occasion reminders, streaks, Admin Insights, the icon pass, Year in Review, header search, Want to Try, plans/roles, menu lookup, the patterns page, Ideas, the multi-year view and Where To Eat — are **built and committed but not yet pushed to Netlify**, so they are not on the live site yet; `ROADMAP.md` marks them. Everything else here is live.
>
