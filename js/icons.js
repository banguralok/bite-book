...
const BiteBookIcons = (() => {
  const PATHS = {
    ...
    'eye-off': '<path d="M3.5 3.5l17 17"/><path d="M10.7 5.6A11 11 0 0 1 12 5.5c6 0 9.5 6.5 9.5 6.5a15 15 0 0 1-2.9 3.8M7.4 7.4C4.4 9.1 2.5 12 2.5 12s3.5 6.5 9.5 6.5a9.9 9.9 0 0 0 3.8-.8"/><path d="M9.9 9.9a3 3 0 0 0 4.2 4.2"/>',
  };
